...
import { Fragment, createRef, useState, useEffect, ChangeEvent } from 'react';
...
const SubPage = () => {
  ...
  //--> handling Upload type & action
  const openFileInput = (type: string) => {
    if (!ownSub) return;
    fileInputRef.current.name = type;
    fileInputRef.current.click(); //triggers the input
  };
    ...
    <div>
      ...
      {sub && (
        <Fragment>
          ...
          {/* Banner image*/}
          <div
            className={classNames('bg-orange-500', {
